...
const DefaultBuildTags = "with_gvisor,with_quic,with_dhcp,with_wireguard,with_utls,with_purego,with_naive_outbound,badlinkname,tfogo_checklinkname0,with_xhttp,with_mieru,with_balancer,with_ssh,with_acme,with_grpc,with_awg,with_carrier,with_demux,with_derp,with_hysteria_transport,with_shadowquic,with_sudoku,with_trusttunnel"
